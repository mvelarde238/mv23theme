...
<div class="postcard postcard--style1" <?php echo implode(' ', $postcard_attributes) ?>>
	...
	<div class="postcard__content">
		...
		<p class="postcard__date"><?php printf( '%1$s','<time class="entry-time" datetime="' . get_the_time('Y-m-d', 	$id) . '" itemprop="datePublished">' . get_the_time(get_option('date_format'), $id) . '</time>'); ?></p>
