...
Container::create( 'page_settings' )
    ...
    ->add_fields(array(
        ...
        Field::create( 'select', 'static_header_logo', 'Versión del Logo')->add_options($logos_field_names)->add_dependency('custom_static_header'),
        ...
        Field::create( 'select', 'sticky_header_logo', 'Versión del Logo')->add_options($logos_field_names)->add_dependency('custom_sticky_header'),
