...
$card_args = array(
    'title' => 'Card',
    'edit_mode' => 'popup',
    'fields' => array_merge($fields, $aspect_ratio_fields, $videocard_fields, $acciones_fields, $card_settings_fields, $margenes, $bordes, $box_shadow, $animation, $scroll_animation_fields)
);
