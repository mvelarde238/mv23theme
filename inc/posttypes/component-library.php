<?php
function create_component_library_post_type() {
	...
	$labels = array(
		...
		'new_item'              => __( 'Nuevo componente', 'default' ),
		'edit_item'             => __( 'Editar componente', 'default' ),
		'update_item'           => __( 'Actualizar componente', 'default' ),
		'view_item'             => __( 'Ver componente', 'default' ),
		'view_items'            => __( 'Ver componente', 'default' ),
		'search_items'          => __( 'Buscar componente', 'default' ),
	...
	register_post_type( 'component_library', $args );

}
add_action( 'init', 'create_component_library_post_type', 0 );
