...
class Icon_and_Text extends Component {
	...
	public static function get_fields() {
		$fields = array(
            ...
            Field::create( 'image_select', 'istyle', 'Estilo')->add_options(array(
                'default'  => array(
                    'label' => 'Normal',
                    'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icon-default.png'
                ),
                'circle'  => array(
                    'label' => 'Circular',
                    'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icon-circle.png'
                ),
                'circle-outline'  => array(
                    'label' => 'Circular y Lineal',
                    'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icon-circle-outline.png'
                ),
            ))->set_width(30),
            ...
            Field::create( 'image_select', 'iposition', 'Posición')->add_options(array(
                'left'  => array(
                    'label' => 'Izquierda',
                    'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icon-left.png'
                ),
                'top'  => array(
                    'label' => 'Arriba',
                    'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icon-top.png'
                ),
                'right'  => array(
                    'label' => 'Derecha',
                    'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icon-right.png'
                ),
            ))->set_width(30),
            ...
            //     'center'  => array(
            //         'label' => 'Centro',
            //         'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icono-centro.png'
            //     ),
            //     'flex-start'  => array(
            //         'label' => 'Arriba',
            //         'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icono-arriba.png'
            //     ),
            //     'flex-end'  => array(
            //         'label' => 'Abajo',
            //         'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icono-abajo.png'
            //     ),
            ...
            //     'left'  => array(
            //         'label' => 'Izquierda',
            //         'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icon-top-left.png'
            //     ),
            //     'right'  => array(
            //         'label' => 'Derecha',
            //         'image' =>  THEME_CUSTOM_FIELDS_PATH.'/images/icon-top-right.png'
            //     ),
            // ))->set_width(33)->add_dependency('iposition','top','='),
    ...
    public static function display( $args ){
        ...
        $ibgc = ($args['ibgc'] == '') ? get_main_color() : $args['ibgc'];
