...
class Core {
	...
	public function register_scripts() {
		$src = 'https://maps.googleapis.com/maps/api/js?libraries=places';
			$src .= '&key=AIzaSyB4WgG02INNI9A_3V1pxMVsstKGDX4blvc';
		// if( $key = get_option( 'uf_google_maps_api_key' ) ) { mv23
		...
		wp_register_script( 'uf-field-boton',         $js . 'field/boton.js',         array( 'uf-field' ), $v );
		wp_register_script( 'uf-field-menu-selector', $js . 'field/menu-selector.js', array( 'uf-field' ), $v );
