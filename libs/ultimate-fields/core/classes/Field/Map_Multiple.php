 ...
 * @since 3.0
 */
class Map_Multiple extends Field {
	/**
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'uf-field-map-multiple' );
	 ...
	 * @return Ultimate_Fields\Field\Map_Multiple The instance of the field, useful for chaining.
	 */
	 ...
	 * @return Ultimate_Fields\Field\Map_Multiple
	 */
	...
	public function handle( $value, $source = null ) {
		...
		if( ! is_array( $value ) || ! isset( $value['coordenadas'] ) ) {
			return false;
		}
	...
	public function get_api_key() {
		/**
		 * Allows the API key that is being used for a Map_Multiple field to be changed.
		 *
		 * @since 3.0
		 *
		 * @param string $api_key The API key for Google.
		 * @param Ultimate_Fields\Field\Map_Multiple $field The field whose key is being modified.
		 */
