...
class Xab extends Field {
	...
	/**
	 * Changes the icon of the xab.
	 *
	 * @since 3.0
	 *
	 * @param string $icon The CSS class for the icon element.
	 * @return Xab The instance of the field.
	 */
	...
	public function enqueue_scripts() {
		wp_enqueue_script( 'uf-xab' );

		Template::add( 'inline-xab', 'container/inline-xab' );
	}
	...
	/**
	 * Ensures that unlike normal fields, no values are saved for xabs.
	 *
	 * @since 3.0.2
	 *
