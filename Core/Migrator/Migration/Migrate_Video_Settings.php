...
class Migrate_Video_Settings{
    ...
    public function migrate(){
        ...
        add_action( 'wp_ajax_process_new_video_settings', array($this, 'ajax_process_page_data') );
        add_action( 'wp_ajax_after_new_video_settings', array($this, 'ajax_after_data_migration') );
    }
    ...
    public function display(){
        ...
        <div class="wrap">
            <div class="theme-migrator">
                <h3>―――― Migrate Video Settings ( For version >= 2.5.0 )</h3>
                ――――― <button class="theme-migrator__init-new-video-settings button-primary" data-status="initial">
    ...
    public function enqueue_migrator_scripts( $hook ) {
        ...
        wp_enqueue_script($slug.'-new-video-settings', THEME_MIGRATOR_PATH . '/scripts/migrate-video-settings.js', array('jquery'), '1.0', true);
    }
