...
class Migrate_Gmaps_to_Leaflet{
    ...
    public function display(){
        ...
        <div class="wrap">
            <div class="theme-migrator">
                <h3>―――― Migrate Google Maps to Leaflet Maps ( To level up to versions >= 2.0.1 )</h3>
    ...
    public function enqueue_migrator_scripts( $hook ) {
        ...
        wp_enqueue_script($slug.'-gm-to-leaflet', THEME_MIGRATOR_PATH . '/scripts/migrate-gmaps-to-leaflet.js', array($slug.'-scripts'), '1.0', true);
    }
