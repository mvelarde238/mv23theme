...
class Manager {
    ...
    public function export_options_via_ajax() {
        ...
        $options = array();
        $options_list = array('theme_colors','fonts','typography_css_vars','static_header_logo','custom_static_header_logo','static_header_logo_height','static_header_bgc','static_header_color_scheme','sticky_header_logo','custom_sticky_header_logo','sticky_header_logo_height','sticky_header_bgc','sticky_header_color_scheme','containers_width');
