    ...
    public static function init(){
        Container::create( 'main_theme_options' )
            ...
            ->add_location( 'customizer', array(
                'postmessage_fields' => array( 'theme_colors', 'typography_css_vars', 'static_header_logo_height', 'sticky_header_logo_height', 'static_header_bgc', 'sticky_header_bgc', 'containers_width' )
            ))
