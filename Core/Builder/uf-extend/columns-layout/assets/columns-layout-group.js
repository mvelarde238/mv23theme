(function( $ ){
	...
	/**
	 * This file handles the Group container of Ultimate Fields that is used for columns layouts.
	 */
	var container   = UltimateFields.Container,
		group       = container.Group,
		columnsLayoutGroup = container.Columns_Layout_Group = {};

	/**
	 * Extend the model of the group for layout groups.
	 */
	columnsLayoutGroup.Model = group.Model.extend({
	 ...
	 */
	columnsLayoutGroup.View = group.View.extend({
		...
		render: function() {
			var that = this,
				tmpl = UltimateFields.template( 'columns-layout-group' );
