...
class Columns_Layout {
	...
	public function generate_field_class( $class_name, $type ) {
		if( 'columns_layout' === strtolower( $type ) ) {
			return Field::class;
		} else {
			return $class_name;
		}
	...
	public function register_scripts() {
		...
		// FIELD SCRIPT
		wp_register_script( 'uf-columns-layout', $assets . 'columns-layout.js', array( 'uf-field' ), $v );
		wp_register_script( 'uf-columns-layout-group', $assets . 'columns-layout-group.js', array( 'uf-field' ), $v );
		wp_register_script( 'uf-field-columns-layout', $assets . 'field-columns-layout.js', array( 'uf-field', 'uf-columns-layout-group' ), $v );
		wp_register_style( 'uf-field-columns-layout', $assets . 'columns-layout.css', array( 'ultimate-fields-css' ), $v );
	}
}
